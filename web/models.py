...
class Project(models.Model):
    ...
    bucket = models.CharField(verbose_name='cos桶', max_length=128, default=None)
    region = models.CharField(verbose_name='cos区域', max_length=32, default=None)
...
class Wiki(models.Model):
    ...
    # 自关联
    parent = models.ForeignKey(verbose_name='父文章', to='self', null=True, blank=True, on_delete=models.CASCADE,
...
class Issues(models.Model):
    ...
    priority = models.CharField(verbose_name='优先级', max_length=12, choices=priority_choices, default='success')
    ...
    status = models.SmallIntegerField(verbose_name='状态', choices=status_code, default=1)
